  ...
  <div class="container">
    ...
    <div class="collapse navbar-collapse" id="navbarResponsive">
      <ul class="navbar-nav ml-auto">
        <li class="nav-item">
          <a class="nav-link" href="https://github.com/ChaabaneMohamed/AffectionTER">About</a>
        </li>
        <li class="nav-item">
          <a class="nav-link" href="http://pageperso.lif.univ-mrs.fr/~kevin.perrot/">Contact</a>
        </li>
